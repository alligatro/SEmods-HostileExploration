...
namespace HostileExploration{
	...
	public class PlanetaryInstallations : MySessionComponentBase{
		...
		public int spawnTimerTrigger = 2; //Seconds until mod attempts to spawn new Installation(s)
		...
		public int mediumInstallationChanceBase = 0; //If spawning small station, this is chance percent a medium station will appear instead.
		public int mediumInstallationChanceIncrement = 0; //For each small station spawn, mediumInstallationChanceBase increases by this amount
		public int mediumInstallationAttempts = 0;
		public int largeInstallationChanceBase = 0; //If spawning medium station, this is chance percent a large station will appear instead.
		public int largeInstallationChanceIncrement = 0; //For each medium station spawn, largeInstallationChanceBase increases by this amount
		...
		public double maxSpawnDistFromPlayer = 5000; //Maximum distance from player to spawn at.
		public double mediumSpawnDistFromPlayerAdd = 500; //This value is added to the min/max spawndistfromplayer if installation is Medium
		public double largeSpawnDistFromPlayerAdd = 1000; //This value is added to the min/max spawndistfromplayer if installation is Large
		...
		List<MySpawnGroupDefinition> explorationSpawnGroups = new List<MySpawnGroupDefinition>();
